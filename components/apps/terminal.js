...
export class Terminal extends Component {
  constructor() {
    ...
    this.child_directories = {
      ...
      projects: [
        "hybrid-cloud-using-openstack",
        "handwritten-digit-classification-using-mobile-offloading",
        "beeswarm-visualization-of-global-development-trends",
        "scalable-image-classification-with-aws-optimization",
        "cluster-validation-meal-data-analysis",
        "data-visualization-vast-2022",
        "pass-genius",
    ...
    return (
      <React.Fragment key={id}>
        <div className="flex w-full h-5">
          <div className="flex">
            <div className=" text-ubt-green">prasidh@Dell</div>
  ...
  handleCommands = (command, rowId) => {
    ...
    switch (main) {
      ...
      case "pwd":
        ...
        result = str.replace("~", "/home/prasidh");
        break;
      case "code":
        if (words[0] === "." || words.length === 0) {
          ...
          result =
            "Command '" +
            main +
            "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-prasidh, todoist, trash, settings, sendmsg]";
        }
        break;
      case "echo":
      ...
      case "about-prasidh":
        if (words[0] === "." || words.length === 0) {
          this.props.openApp("about-prasidh");
        } else {
          result =
            "Command '" +
            main +
