...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            skills: ["back-end development", "Java", "Microservices", "SQL", "SpringBoot", "Docker", "K8s", "git"],
            projects: ["prasidh-agg-personal-portfolio", "image-classification", "face-recognition", "fibo-calculator"],
        ...
        switch (main) {
            ...
            case "code":
                if (words[0] === "." || words.length === 0) {
                    ...
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-prasidh, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
